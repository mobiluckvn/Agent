...
> SL-175), sheet Khoảng trống từ 15 xuống **2 dòng**, và bộ test từ 2.395 xanh /
> 10 đỏ lên **2.596 xanh / 0 đỏ**. Rà soát vòng hai (§7) thêm 4 nghiệp vụ bảng
...
**N-911 đã làm** (SL-174, TC-134) — rẻ đi hẳn nhờ N-913 làm trước: sổ số đo
mang sẵn trường đơn vị, nên phép soi thứ nguyên có nguồn để tra.
**N-912 đã làm** (SL-175, TC-135) — `eaa observe`, và nó tìm ra ngay trên dự án
thật: 9/9 module chưa khai dấu hiệu, và **không kênh quan sát nào** trong hồ sơ.
