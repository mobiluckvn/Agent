...
| [`docs/EAA_Benchmark_San_pham.docx`](docs/EAA_Benchmark_San_pham.docx) | **Báo cáo benchmark bốn lớp** — tính năng · kiến trúc lõi · phi chức năng · UI/UX. 18 số đo kèm lệnh tái lập, 8 việc phải làm. Có cả `.md` và `.pdf` |
